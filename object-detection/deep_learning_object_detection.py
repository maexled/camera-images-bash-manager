...
(h, w) = image.shape[:2]
#blob = cv2.dnn.blobFromImage(image, 0.007843, (1920, 1080), 130)
blob = cv2.dnn.blobFromImage(image, 0.00392, (812, 812), True, crop=False)
...
for i in np.arange(0, detections.shape[2]):
	...
	if confidence > args["confidence"]:
            ...
            if (CLASSES[idx] == "person" or CLASSES[idx] == "cat" or CLASSES[idx] == "bicycle"):
